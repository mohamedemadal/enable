<template>
  <div
    class="details bg-[url('../image/sec1/about.png')] bg-cover bg-no-repeat"
  >
    <div class="grid grid-row-3 md:grid-cols-3 p-10 gap-5">
      <div class="grid grid-row-4 gap-5 md:gap-0">
        <router-link to="/web">
          <p  class="text-xl cursor-pointer sec2 font-bold hover:text-[#8B6D00]">
          {{ $t("home") }}
        </p>
        </router-link>
        
        <router-link to="/web/AboutView">
          <p class="text-xl sec2 font-bold cursor-pointer hover:text-[#8B6D00]">
          {{ $t("about_us") }}
        </p>
        </router-link>

        <router-link to="/web/contactus">
          <p class="text-xl sec2 cursor-pointer font-bold hover:text-[#8B6D00]">
          {{ $t("connect_us") }}
        </p>
        </router-link>
