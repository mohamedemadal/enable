...
const edit=(id)=>{
    axios.get(`/api/barrier-subtest/${id}`).then((res)=>{
    loading.value= false
...
const editescrud=()=>{
    axios
    .post(`/api/barrier-subtest/${confir_id.value}`,levels.value)
    .then((res) => {
...
const createcrude=()=>{
    axios
    .post('/api/barrier-subtest',levels.value)
    .then((res) => {
      console.log(res.data)
      fetchData()
      createdialog.value=!(createdialog.value)
...
const deleteAction = () => {
  axios
    .delete(`/api/barrier-subtest/${confir_id.value}`)
    .then((res) => {
      console.log(res.data)
