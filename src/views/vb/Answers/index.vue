...
onBeforeMount(() => {
 ...
 const fetchData= ()=>{
  ...
  axios.get("/api/milestone-answers").then((res)=>{
    loading.value= false
...
const edit=(id)=>{
  router.push({name:'answer-update',params:{'id':id} })
}
        ...
        >
          <template #header>
            <div class="flex w-full  justify-between align-items-center">
              <h5 class="m-0 my-auto">{{ $t("Answers") }}</h5>
             <div>
          ...
          <Column selection-mode="multiple" header-style="width: 3rem"></Column>
           ...
           <Column field="score" :header='$t("score")' :sortable="true" header-style="width:14%; min-width:10rem;" class="ltr:text-justify">
