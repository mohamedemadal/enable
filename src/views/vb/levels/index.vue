...
const edit=(id)=>{
    axios.get(`/api/mileston-levels/${id}`).then((res)=>{
    loading.value= false
...
const editescrud=()=>{
    axios
    .post(`/api/mileston-levels/${confir_id.value}`,levels.value)
    .then((res) => {
...
const createcrude=()=>{
    axios
    .post('/api/mileston-levels',levels.value)
    .then((res) => {
      console.log(res.data)
      fetchData()
      createdialog.value=!(createdialog.value)
...
const deleteAction = () => {
  axios
    .delete(`/api/mileston-levels/${confir_id.value}`)
    .then((res) => {
      console.log(res.data)
